...
//             const response = await axios.get(`http://localhost:8000/posts`); // this is for mockData from db.json
            const response = await axios.get(`http://localhost:8080/jobPosts`); // this will get data from SpringBoot
